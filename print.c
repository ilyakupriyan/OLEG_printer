 ...
 */
static void show_supported(http_t   *http,	    /* I - Connection to destination */
	       cups_dest_t  *dest,	    /* I - Destination */
...
{		
    if (arg)
        printf("printDest: Unknown option \"%s\".\n", arg);
    puts("Usage:");
    puts("  ./print name [operation ...]");
    puts("  ./print ipp://... [operation ...]");
    puts("  ./print ipps://... [operation ...]");
    puts("  ./print --enum [grayscale] [color] [duplex] [staple] [small]\n"
         "                 [medium] [large]");
    puts("");
    puts("Operations:");
